...
| 🛡️ **Guided permissions** | In-app reminders and a guided System Settings flow |
...
3. Launch PeekOCR
4. Open any capture mode, or use the menu bar reminder, to enable the required permissions with the guided setup flow
